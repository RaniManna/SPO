...
%precedence    OP CP SBO SBC      //%precedence ?
%precedence    WHILE
...
%%
program: funcDef program{ $$ = root = insert_def_list(make_program($1), $2);}
       | funcDef { $$ = root = insert_def_list(make_program( $1 ), NULL); }
       ;
